...
The event script is fully translated and this release is ready for broad
playtesting. It remains an alpha while image-based menus and final visual
...
| Patch build | 16,848 validated replacements |

## Download and apply

Download `tricolore_crise_english_patch_v0.9.0-alpha.bps` from the latest
...
- Title/start-screen and some other image-based Japanese UI art.
